...
$: s("fdarkkick:2!4").sometimesBy(0.1, x=>x.ply("2")).rib(16,4)
  .gain(1.5).duckorbit(2).duckattack(0.1);

$: s("~ fohh:3").fast(4).decay(0.03).speed(16).hpf(250)
...
_$: s("400-coffees").slow(8).slice(8, `<0 1 2 3 4 5 6 7>`).gain(1.15)
_$: s("400-coffees:1").slow(8).slice(8, `<0 1 2 3 4 5 6 7>`).gain(1.15)

_$: s("400-coffees:1").slow(8).slice(8, `<0 ~ 2 ~ 4 ~ 6 ~>`).decay(0.5).delay(.2).room(1.4).gain(2)
...
_$: n(irand(8).seg(8))
    .scale("<g1:major:pentatonic d1:major:pentatonic e1:minor:pentatonic d1:major:pentatonic>")
    .s("recorder_bass_sus")
    .rib(4,4)
    .orbit(2)
    .hpf(250)
