...
const energy_hat = s("hat_afterparty*16").degradeBy(slider(0.36,0,1))
  .almostNever(x=>x.speed("0.5"))
  .jux(rev).gain("0.3");
...
const first_verse = s("youngandnauseous:1").slow(4).gain(1.5)
...
const second_verse = s("youngandnauseous:5").slow(4).gain(1.5)
